...
export const DiscordIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20.222 0c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2h-18c-1.1 0-2-.9-2-2V2c0-1.1.9-2 2-2h18z" fill="currentColor"/>
    <path d="M16.5 8c0 0-3-3-7-3s-7 3-7 3v11c0 0 2 2 7 2s7-2 7-2V8zm-5 7c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm4-4c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" fill="white"/>
  </svg>
);
